...
class OfficialDepartmentReport extends Component
{
    ...
    protected $rules = [
        ...
        public function getreport(){
            $this->validate();
            return redirect()->route('reports.official.department.data',['department_id'=>$this->department_id,'week_id'=>$this->week_id]);
        }
    public function render()
    {
        $this->departments=Department::where('school_id',$this->school_id)->get();
        $this->weeks = Week::all();
        return view('livewire.report.official-department-report');
    }
}
