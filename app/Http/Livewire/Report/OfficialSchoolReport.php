...
class OfficialSchoolReport extends Component
{
    ...
    public function getreport(){
        $this->validate();
        return redirect()->route('reports.official.school.data',['school_id'=>$this->school_id]);
    }
...
{   
    ...
    return view('livewire.report.official-school-report');
}
}
